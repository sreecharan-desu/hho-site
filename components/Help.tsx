          ...
          {helpOptions.map((option) => {
            ...
            return (
              ...
              >
                <div className="p-8">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 ${color.bg} rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <p className="text-gray-600 leading-relaxed mb-6 text-sm">{option.desc}</p>

                  <div
                    className={`inline-flex items-center gap-2 ${color.bg} ${color.border} border px-4 py-2 rounded-full mb-6`}
                  >
                    <div
                      className={`w-2 h-2 ${color.icon.replace("text-", "bg-")} rounded-full`}
                    ></div>
                  ...
                  <motion.button
                    className={`w-full ${color.button} text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg group-hover:shadow-xl`}
                ...
                <div
                  className={`absolute bottom-0 left-0 right-0 h-1 ${color.icon.replace(
                    "text-",
                    "bg-"
